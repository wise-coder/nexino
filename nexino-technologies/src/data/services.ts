...
function createService(seed: ServiceSeed): Service {
  return {
    ...
    seo: seed.seo ?? {
      title: `${seed.title} — Nexino Technologies`,
...
export const services: Service[] = [
  {
    ...
    seo: {
      title: 'Corporate Website Development — Nexino Technologies',
  ...
  },
  {
    ...
    seo: {
      title: 'Custom Web Application Development — Nexino Technologies',
...

  {
    ...
    seo: {
      title: 'AI Agent Development — Nexino Technologies',
  ...
  },
  {
    ...
    seo: {
      title: 'Business Chatbot Development — Nexino Technologies',
  ...
  },
  {
    ...
    seo: {
      title: 'Hosting and Website Maintenance — Nexino Technologies',
  ...
  },
  {
    ...
    seo: {
      title: 'Data Analytics Services — Nexino Technologies',
  ...
  },
  {
    ...
    seo: {
      title: 'Embedded Systems Development — Nexino Technologies',
...
const additionalServices: Service[] = [
  createService({
    ...
    relatedServiceSlugs: ['custom-web-applications', 'ui-ux-design', 'hosting-maintenance'],
    seo: {
      title: 'Mobile Application Development — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'E-Commerce Platform Development — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'SaaS Product Development — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'UI/UX Design Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'WhatsApp Automation Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Workflow Automation Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Customer Support Automation — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Cloud Infrastructure Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'System Integration Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Business Intelligence Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Technical Research Services — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Custom PCB Design — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Hardware and Software Integration — Nexino Technologies',
  ...
  createService({
    ...
    seo: {
      title: 'Intelligent Infrastructure Services — Nexino Technologies',
