...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Engineering intelligent solutions for a changing world. Software, AI, cloud and embedded systems.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Nexino Technologies' }],
  },
  twitter: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${plusJakarta.variable} h-full`}>
      <body className="min-h-full flex flex-col antialiased bg-white text-nexino-text">
